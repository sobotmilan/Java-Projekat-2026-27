...
/**
 *
 * Klasa koja predstavlja podtip klase {@link Tanker} namijenjen za reprezentovanje tankera u upotrebi od strane vatrogasaca.
 *
 * <p>Za razliku od roditeljske klase {@link Tanker}, ova klasa implementira ugovor nametnut od strane interfejsa {@link Vatrogasci} kroz atribut instance {@code rotacija}.
 * Vatrogasna plovila mogu biti isključivo tankeri.</p>
 *
 * @author Milan Šobot
 * @version 1.0
 * @see Tanker
...
public class TankerVatrogasci extends Tanker implements Vatrogasci {
    /** Prioritet vatrogasnog plovila dok mu je upaljena rotacija. Najviši prioritet od svih službenih plovila. */
